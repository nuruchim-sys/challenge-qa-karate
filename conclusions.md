...
* **Speed:** Once the connection was established, the update and query-by-status operations performed much faster (380ms and 415ms respectively), indicating good responsiveness under sequential load.
